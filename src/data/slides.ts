...
export const slides: SlideData[] = [
  ...
  },
  {
    ...
    subtitle: 'Hiểm họa tấn công mạng hỗ trợ bởi AI & Thiệt hại 18.000 tỷ đồng tại Việt Nam',
    highlightMessage: '“AI chỉ là công cụ do con người nghiên cứu ra. Quyết định sử dụng vào việc gì lại chính là con người.”',
    bgImage: 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&w=1920&q=80',
    accentColor: 'cyan',
  },
  {
